...
- MySQL, REST APIs, JSON, AJAX  
- Custom WordPress Themes & Plugins  
- WooCommerce, Shopify, Custom eCommerce

### **🎨 Front‑End & UI/UX**
- HTML5, CSS3, SCSS, LESS, Bootstrap  
- React, jQuery  
- Figma → HTML/WordPress (Pixel‑Perfect)  
- Responsive UI/UX, Performance Optimization  
- SEO‑Friendly Development (Schema, On‑Page, Clean Code)
